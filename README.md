...
#### If you have [conda environment](https://anaconda.org/anaconda/) in the terminal environment.
...
## xTB install
https://xtb-python.readthedocs.io/en/latest/installation.html#installation
...
## Directory Structure [eg. VASP calculator]
```bash
>> Project Root
├── INCAR
├── POSCAR
