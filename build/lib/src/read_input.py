...
def load_config(input_file="input.yaml"):
    ...
    config['deepmd_setup']['train_dir'] = config['deepmd_setup'].get('train_dir', 'DeePMD_training/01.train')
    config['deepmd_setup']['dpmd_dir'] = config['deepmd_setup'].get('dpmd_dir', 'DeePMD_training/02.mdrun')
