...
#---------------------------------------------------------------------------------------------------#
from src.utils import log_md_setup, save_xyz, load_md_checkpoint, save_md_checkpoint, check_physical_limits  # Import these functions from utils module
#===================================================================================================#
...
def run_Ase_DPMD(system, dyn, steps, pace, log_filename, trajfile, dir_name, distance_metrics):
    """
    ...
    for step in range(steps):
        ...
        # Check physical limits after each step if distance metrics are provided
        if distance_metrics and check_physical_limits(system, distance_metrics):
            print("Physical limits exceeded. Stopping DPMD simulation.")
            break
