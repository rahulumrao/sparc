...
def QueryByCommittee(trajfile, model_path, num_models, data_path, outfile='model_dev.out'):
    """
...
#---------------------------------------------------------------------------------------------------------
    labelling(trajfile, outfile, min_lim=None, max_lim=None, dpmd_dir='poscar_files')
#===================================================================================================#
#                                     END OF FILE 
#===================================================================================================#    
