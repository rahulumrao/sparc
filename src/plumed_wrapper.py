...
# Setup PLUMED
#===================================================================================================#
def modify_forces(calculator, system, timestep, temperature, kT, restart, plumed_input='plumed.dat'):
    """
    ...
    plumed_calc = Plumed(calc=calculator, input=setup, timestep=timestep, atoms=system, kT=kT, log='PLUMED.log', restart=restart)
